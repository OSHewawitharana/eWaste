...
<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tpno" type="text" class="form-control{{ $errors->has('tpno') ? ' is-invalid' : '' }}" name="tpno" value="{{ old('tpno') }}" required>
...
<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="textarea" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{ old('address') }}" required>
...
<div class="form-group row ">
                           ...
                           <label for="category" class="col-md-4 col-form-label text-md-right">{{ __('Type') }}</label>
                           <div class="col-md-6">
...
<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="textarea" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" value="{{ old('description') }}" >
